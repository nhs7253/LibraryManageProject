...
<div>
	<a href="/LibraryManage/forAdmin/book_manage.jsp">책정보관리</a> <a
		href="/LibraryManage/forAdmin/admin_book_list.jsp">도서대출</a> <a
		href="/LibraryManage/forAdmin/admin_rental_list.jsp">도서반납</a> <a
		href="">전체회원목록</a> <a
		href="/LibraryManage/forAdmin/admin_wait_list.jsp">도서예약현황</a>
	<a href = "/LibraryManage/forAdmin/book_manage.jsp" >책정보관리</a>
	<a href = "/LibraryManage/forAdmin/admin_book_list.jsp" >도서대출</a>
	<a href = "/LibraryManage/forAdmin/admin_rental_list.jsp" >도서반납</a>
	<a href = "/LibraryManage/forAdmin/all_user_list.jsp" >전체회원목록</a>
